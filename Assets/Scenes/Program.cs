...
namespace Com.Expload.Program {
    ...
    class EmitRequest: ProgramRequest<object> {
        ...
        public IEnumerator Emit(int arg0)
        {
            String json = String.Format("{{ \"address\": {0}, \"method\": \"emit\", \"args\": [{{ \"value\": {1}, \"tpe\": \"int32\" }}] }}",  "\"" + BitConverter.ToString(ProgramAddress).Replace("-","") + "\"" , arg0);
